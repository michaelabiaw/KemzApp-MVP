...
from . import app, db  # Import the Flask app instance and the database instance
from .models import Venue, Artist  # Import the data models
from .forms import VenueForm, ArtistForm  # Import the forms
from ecomz.views import app
